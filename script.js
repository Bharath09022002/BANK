...
// Function to check if the user is logged in (to be used in transaction.html)
function checkLogin() {
...
// Call checkLogin() on transaction.html or transaction-history.html pages
if (window.location.pathname.includes("transaction.html") || window.location.pathname.includes("transaction-history.html")) {
    checkLogin();
}
